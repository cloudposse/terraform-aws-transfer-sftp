...
| <a name="input_allowed_cidrs"></a> [allowed\_cidrs](#input\_allowed\_cidrs) | A list of CIDR's allowed to connect to the SFTP endpoint. This has precedence over vpc\_security\_group\_ids. | `list(string)` | `[]` | no |
