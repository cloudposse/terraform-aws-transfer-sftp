...
| <a name="input_sftp_restricted"></a> [sftp\_restricted](#input\_sftp\_restricted) | Restricts SFTP users so they only have access to their home directories. | `bool` | `true` | no |
