...
output "security_group_id" {
  value       = local.security_group_enabled ? join("", module.security_group.*.id) : ""
  description = "The ID of the created security group"
}

output "security_group_arn" {
  value       = local.security_group_enabled ? join("", module.security_group.*.arn) : ""
  description = "The ARN of the created security group"
}

output "security_group_name" {
  value       = local.security_group_enabled ? join("", module.security_group.*.name) : ""
