...
| <a name="input_pre_authentication_login_banner"></a> [pre\_authentication\_login\_banner](#input\_pre\_authentication\_login\_banner) | Specify a string to display when users connect to a server. This string is displayed before the user authenticates. The SFTP protocol does not support post-authentication display banners. | `string` | `null` | no |
